...
class OrderItem(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    order_id = db.Column(
        "commande_id", db.Integer, db.ForeignKey("order.id"), nullable=False
    )
    product_id = db.Column(
        "produit_id", db.Integer, db.ForeignKey("product.id"), nullable=False
    )
    quantity = db.Column("quantite", db.Integer, nullable=False)
